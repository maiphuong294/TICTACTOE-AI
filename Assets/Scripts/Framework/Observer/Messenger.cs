...
internal static class Messenger
{
    ...
    //No parameters
    public static void FireEvent(EventKey eventType)
    {
    ...
    //Single parameter
    public static void FireEvent<T>(EventKey eventType, T arg1)
    {
#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
            Debug.Log("MESSENGER\t" + System.DateTime.Now.ToEventKey("hh:mm:ss.fff") + "\t\t\tInvoking \t\"" + eventType + "\"");
#endif
    ...
    //Two parameters
    public static void FireEvent<T, U>(EventKey eventType, T arg1, U arg2)
    {
#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
            Debug.Log("MESSENGER\t" + System.DateTime.Now.ToEventKey("hh:mm:ss.fff") + "\t\t\tInvoking \t\"" + eventType + "\"");
#endif
    ...
    //Three parameters
    public static void FireEvent<T, U, V>(EventKey eventType, T arg1, U arg2, V arg3)
    {
#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
            Debug.Log("MESSENGER\t" + System.DateTime.Now.ToEventKey("hh:mm:ss.fff") + "\t\t\tInvoking \t\"" + eventType + "\"");
#endif
    ...
    //Four parameters
    public static void FireEvent<T, U, V, N>(EventKey eventType, T arg1, U arg2, V arg3, N arg4)
    {
#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
            Debug.Log("MESSENGER\t" + System.DateTime.Now.ToEventKey("hh:mm:ss.fff") + "\t\t\tInvoking \t\"" + eventType + "\"");
#endif
    ...
    //Five parameters
    public static void FireEvent<T, U, V, N, M>(EventKey eventType, T arg1, U arg2, V arg3, N arg4, M arg5)
    {
#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
            Debug.Log("MESSENGER\t" + System.DateTime.Now.ToEventKey("hh:mm:ss.fff") + "\t\t\tInvoking \t\"" + eventType + "\"");
#endif
